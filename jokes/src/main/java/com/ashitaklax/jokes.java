...
public class Jokes {
    ...
    /**
     * This list of jokes came from Funny.com (really quick jokes)
    ...
    {
        int numOfJokes = this.jokeArr.length;
        int randomNumber = ThreadLocalRandom.current().nextInt(0,numOfJokes);
        return this.jokeArr[randomNumber];
